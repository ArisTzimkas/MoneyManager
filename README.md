...
1.  Head to [Releases](https://github.com/ArisTzimkas/MoneyManager/releases).
2.  Download the "MoneyManager.apk" file of the latest release available.
3.  Then install it on your device.
