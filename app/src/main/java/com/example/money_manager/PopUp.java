...
import com.example.money_manager.database.UserTotal;
...
public class PopUp extends AppCompatActivity {
    ...
    private void createNotification() {
        ...
        String formattedNumber = numberFormatter.format((double) value);
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "not1")
                ...
                .setContentText(selectedCategory + ": " + formattedNumber +"€")
